...
def convert_base(x, original_base, new_base=10):
    """Converts any Base to any Base but is limited to Base2 through Base36. Default new base is set to 10.
    Extending to a new base is not yet available with this function.
    """
